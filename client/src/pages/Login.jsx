        ...
        <section className='flex justify-center items-center bg-black min-h-screen text-white'>
            <div className='bg-zinc-900 p-10 w-sm h-xl flex flex-col justify-center items-center gap-5 rounded-2xl'>
                <div className='flex flex-col justify-center items-center gap-1'>
                    <h2 className='text-2xl sm:text-3xl font-extrabold text-center'>Login</h2>
                    <p className='text-xl font-light text-center'>Welcome Back</p>
                </div>
                <form onSubmit={handleSubmit} action="" className='flex flex-col justify-center gap-5'>
                    ...
                    <div className='flex justify-center items-center mt-3'>
                        <button type='submit' className="bg-white text-black hover:bg-zinc-700 hover:text-white transition-colors duration-200 font-bold p-2 rounded-xl cursor-pointer w-full">Login</button>
                    </div>
                </form>
                <div className='flex flex-col gap-3'>
                    <p>
                        Don't have an account? <Link to="/signup" className='text-blue-500 hover:text-blue-600 underline'>Sign Up </Link>
                    </p>
